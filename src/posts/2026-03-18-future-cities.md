---
title: "What Would a Perfect City Look Like?"
...
image: "/images/posts/bf-future-cities.png"
---
...
- Split screen: conventional city grid vs geodesic city dome
- Animation: heat flowing out of Building A, Building B heating the same air
- The Winooski dome proposal (archival images exist)
- Dymaxion House footage/images
- 95% idle car visualization: parking lot vs park
- Ephemeralization animation: satellite vs copper cable

Radio break points:
- After "Every box works. The system fails." (strong cliffhanger)
- After "what is the minimum structure that does it?" (setup for the list)
- After the numbers section (pause before the design challenge)

Best social clip: "Buildings consume 40% of US energy. Most of it is wasted through inefficient design. The problem is not technology. The problem is the frame."
-->
