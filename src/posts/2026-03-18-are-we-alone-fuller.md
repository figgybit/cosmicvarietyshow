...
- Split screen: fleet of ships vs single ship alone in vast ocean
- The Pale Blue Dot photograph with "only crewed vessel" overlay
- World Game footage/stills
- Safety factor diagram: bridge rated for 10 holds 30 vs bridge rated for 10 holds 10
- Timeline of species extinction rate vs cosmic silence

Radio break points:
- After "The engineering specification changes" (strong pause)
- After "the players could not believe the solution was possible" (emotional beat)
- After "designing as if we know it?" (the question that lands)

Best social clip: "If Spaceship Earth is the only crewed vessel in the observable universe, every act of error-correction is precious."
-->
