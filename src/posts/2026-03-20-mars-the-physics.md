---
title: "Can We Get to Mars? What the Equations Say About How Hard It Actually Is"
...
<!-- PRODUCTION NOTES
Visual candidates:
- The rocket equation curve: payload vs fuel, exponential
- Radiation exposure comparison: Earth surface, ISS, Mars transit, career limit
- Mars mission mass budget breakdown: pie chart
- Transit animation: Earth to Mars, seven months, showing the orbital mechanics

Radio break points:
- Rocket equation: 75 seconds
- Radiation: 60 seconds
- Life support math: 60 seconds
- The trim tab (Mars homework = Earth homework): 45 seconds

Social clips:
- "The rocket equation does not negotiate. It is exponential and it is merciless."
- "Every technology you develop for Mars, you need on Earth."

Good video candidate. The rocket equation exponential curve is visually striking.
-->
