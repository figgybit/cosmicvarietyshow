...
image: "/images/posts/bf09-renewable.png"
audio: "/audio/20260322-voice-fuller-renewable-energy-the-answer-is-yes.mp3"
---
...
- Sun energy vs human energy use: 173,000 TW vs 18 TW, scale comparison
- Solar cost curve: 99% drop since 1976 as animated graph
- World Game map: energy flowing across time zones following the Sun
- Geodesic dome overlaid on global grid map
- Split screen: centralized grid (hub and spoke) vs distributed grid (mesh)

Radio break points:
- After "We are not short of energy. We are short of design." (the thesis)
- After "The Sun does not send an invoice." (the economic reveal)
- After "business models fight harder than physics." (the political lens)

Best social clip: "The Sun delivers 173,000 terawatts to Earth every day. Humanity uses 18. We are not short of energy. We are short of design."
-->
