...
<!-- PRODUCTION NOTES
Visual candidates for video version:
- Animation of particles fired one at a time at two slits
- The interference pattern building up dot by dot
- Side-by-side: pattern WITH observer vs WITHOUT observer
- Zoom from human scale down to atomic scale showing probability clouds
- The "certainty from uncertainty" visualization: trillions of uncertain particles averaging into a solid floor

Radio break points:
- Section 1 (Setup through "What Actually Happens"): 60 seconds standalone
- Section 2 (The observation twist): 45 seconds standalone, natural cliffhanger
- Section 3 (What it means + why it matters to you): 90 seconds, the payoff

This post is a STRONG video candidate. The double-slit experiment is one of the most visually demonstrable concepts in physics. Moves to front of video production line.
-->
