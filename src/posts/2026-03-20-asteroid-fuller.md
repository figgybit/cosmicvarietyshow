...
image: "/images/posts/bf03-asteroid.png"
---
...
- Asteroid approach timeline: detection → tracking → deflection decision tree
- The four response methods as a toolkit diagram
- DART impact footage (actual NASA footage exists)
- Cost comparison: planetary defense system vs one aircraft carrier
- Chelyabinsk dashcam footage with "no warning" overlay

Radio break points:
- After "We have demonstrated the capability. We have not built the system." (the gap)
- After "A standing capability. Always on. Always funded. Always ready." (the vision)
- After Richard's paintball quote (the trim tab)

Best social clip: "The dinosaurs ruled for 165 million years. They did not build a telescope. We have ruled for ten thousand. The question is whether we build the SYSTEM."
-->
