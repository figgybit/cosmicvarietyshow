...
- Dymaxion Map with resource flows animated across borders
- Food production vs population: 10 billion capacity, 8 billion people, 1/3 wasted
- Energy ratio: 173,000 TW vs 18 TW, visual scale
- World Game session footage/stills (archival)
- Split screen: competition frame (borders, armies) vs design frame (flows, connections)

Radio break points:
- After "Every time they played, they solved it." (the hook)
- After "The bottleneck was framing." (the thesis)
- After "What would you build if you knew the resources were sufficient?" (the close)

Best social clip: "The world produces enough food for 10 billion people. There are 8 billion. One-third is wasted. The problem is not production. It is design."
-->
