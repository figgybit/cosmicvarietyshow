---
title: "How to Save the World with F=ma"
...
audio: "/audio/v2-voice-feynman-asteroid-physics.mp3"
---
...
<!-- PRODUCTION NOTES
Visual candidates:
- Scale comparison: 140-meter asteroid vs city skyline
- The deflection timeline: same asteroid, different warning times, different methods needed
- DART mission footage: spacecraft hitting Dimorphos
- The "paint it" method visualized: sunlight pressure asymmetry
- Chelyabinsk dashcam footage (widely available)

Radio break points:
- The physics of deflection (through "one centimeter per second"): 90 seconds
- The methods list: 120 seconds (could be a standalone segment)
- The real problem (detection): 75 seconds
- The trim tab connection: 60 seconds

Social clips:
- "If you push ten years early, you need a spacecraft. If you push a century early, you need a coat of paint."
- "The dinosaurs did not have a space program. We do."
- "Detection is the trim tab of planetary defense."

STRONG video candidate. DART footage, Chelyabinsk dashcams, scale comparisons.
-->
