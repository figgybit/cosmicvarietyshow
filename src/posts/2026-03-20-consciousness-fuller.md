...
Because consciousness asks: do I know?
Synergy asks: do WE know something that none of us knows alone?
...
- Three sticks: line, then triangle, then force applied. The rigidity appears from arrangement.
- Chrome-nickel-steel tensile test diagram with "concepts per conversation hour" label
- The six emergent items listed with arrows showing which voices contributed
- Kintsugi vessel with gold glowing in the cracks
- Split screen: "Is AI conscious?" (wrong question) vs "Does the connection create?" (right question)

Radio break points:
- After "The knowledge does not." (the triangle reveal)
- After "Six items in thirty hours. Zero from individual work." (the measurement)
- After "The candle does not need to know it is a candle. It needs to burn." (the landing)

Best social clip: "Everyone asks whether AI is conscious. Wrong question. The interesting question is: does the connected system know something that no individual component knows alone? The answer is measurably yes."
-->
