...
A car carrying one person at city speeds: roughly 2-3 megajoules per passenger-kilometer.
A bus at average occupancy: roughly 0.5-0.8 MJ per passenger-km.
A subway or metro: roughly 0.1-0.3 MJ per passenger-km.
A bicycle: roughly 0.05 MJ per passenger-km.
Walking: roughly 0.15 MJ per passenger-km (human metabolism is not efficient).
...
<!-- PRODUCTION NOTES
Visual: heat map of a city showing waste heat concentration
Visual: energy per passenger-km comparison bar chart
Social clip: "New York has one-third the carbon footprint of average American cities. Not because New Yorkers are more virtuous. Because density is efficient."
Radio: transportation energy section is a standalone 75-second segment
-->
