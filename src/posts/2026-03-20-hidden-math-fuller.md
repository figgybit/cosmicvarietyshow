---
title: "The Hidden Math That Runs Your Life: What an Architect Builds with Probability"
date: 2026-03-20T20:00:00
tags: ["posts", "bucky", "science", "hidden-math"]
...
- Brain icon with "NOT DESIGNED FOR PROBABILITY" overlay
- Birthday problem: 23 people, 50% chance of shared birthday (visual demonstration)
- Checklist vs memory: surgery error rates comparison
- Geodesic dome of thinking: gut + data + checklist + second opinion + probability
- The Trim Tab as probability-compensation device diagram

Radio break points:
- After "it cannot do probability" (the thesis)
- After "You do not fix the brain's tendency. You design systems that compensate." (the reframe)
- After "designing around your own weaknesses is the definition of engineering" (the landing)

Best social clip: "The human brain cannot do probability. This is not a flaw to fix. It is a material property to design around."
-->
