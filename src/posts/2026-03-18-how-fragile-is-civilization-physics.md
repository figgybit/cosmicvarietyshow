...
- Bucky Fuller on the structural dependencies: **[How Fragile Is Civilization? What an Architect Sees](/posts/2026-03-18-fragile-civilization-fuller/)**
...
<!-- PRODUCTION NOTES
Visual candidates:
- Sand pile animation: grains dropping, stable, stable, stable, AVALANCHE
- Phase transition: water heating, 99... 99... 100... STEAM (sudden, total)
- The 2003 blackout: map of the northeastern US, lights going out in nine seconds
- The Suez Canal: satellite view, one ship, global trade stopped
- Dependency web: food depends on transport depends on energy depends on communication, circular, fragile

Radio break points:
- Sand pile through phase transition: 90 seconds standalone
- Power grid story: 60 seconds standalone (great radio segment)
- Three lessons: 60 seconds standalone
- Trim Tab connection: 45 seconds

Social clips:
- "The system that has never failed is the most dangerous system in the room."
- "Stability is not the same as resilience."
- "If you're waiting for a warning sign, you've misunderstood the physics. The warning sign IS the failure."

STRONG video candidate. The sand pile, phase transition, and blackout cascade are all highly visual.
-->
